...
function setAlarm() {
    ...
    var tomorrow = false;
    if(RdayDropBox.value < day.value) {
        tomorrow = true;
    } else if(RdayDropBox.value == day.value && RhourDropBox.value < hours.value) {
        tomorrow = true;
    } else if(RdayDropBox.value == day.value && RhourDropBox == hours.value && RminuteDropBox < minutes.value) {
        tomorrow = true;
    }
...
function eventSubmitPress() {
    ...
    if(EdayDropBox.value == 1) {
        ...
        document.getElementById("28").insertAdjacentHTML('beforeend', "<br>Event: " + allEvents[0].eText.value);
    }
